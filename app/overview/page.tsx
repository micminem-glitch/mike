...
export default function Dashboard() {
  ...
  return (
    /* MASTER LAYOUT CONTAINER WRAPPER: Handles viewport tracking dynamically */
    <div className="w-full min-h-screen bg-slate-950 p-4 sm:p-6 pt-20 md:pt-6">
          ...
          <div className="bg-gradient-to-b from-blue-600 to-blue-900 rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center font-bold text-sm">VX</div>
                <div className="max-w-[180px] truncate">
                  <h2 className="font-semibold text-sm truncate">{userEmail}</h2>
                  <span className="text-xs text-blue-200">Active Asset Node</span>
                </div>
              </div>
              <button 
                onClick={handleLogout}
                className="px-3 py-1 rounded-lg bg-red-500/20 text-red-300 hover:bg-red-500/40 text-xs font-semibold transition-all"
              >
                Disconnect
              </button>
            </div>
          ...
          <div className="bg-[#0b132b] border border-slate-800/80 rounded-2xl p-6 shadow-sm text-white">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-xs text-blue-400 hover:underline font-medium mt-0.5">Telemetry log sequence processing active.</p>
              </div>
            </div>
