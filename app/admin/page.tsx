...
import Sidebar from '../components/Sidebar'; // Points directly to your single shared Sidebar component
...
export default function AdminDashboard() {
  ...
  // IF AUTHENTICATED: RENDER SYSTEM WORKSTATION WITH SIDEBAR LAYOUT ALIGNMENT
  return (
    <div className="min-h-screen bg-slate-950 text-white flex font-sans tracking-tight">
      {/* Universal Side Navigation Component */}
      <Sidebar />

      {/* Main Panel Frame Content Wrapper (Added pl-0 md:pl-64 padding for hamburger button space) */}
      <div className="flex-1 min-w-0 md:pl-4 p-4 sm:p-6 space-y-6 pt-16 md:pt-6">
